...
import { AutocompleteService, GeocoderService, loadMaps, mapsLoaded } from "./GoogleMaps";
export interface LocationSelectorProps {
    // options: ["as"]
    setLocation?: (location: google.maps.places.AutocompletePrediction) =>void;
}
...
export function LocationSelector(props: LocationSelectorProps) {
    ...
    const fetch = useMemo(
        () =>
            throttle((request: google.maps.places.AutocompletionRequest, callback: ((a: google.maps.places.AutocompletePrediction[] | null, b: google.maps.places.PlacesServiceStatus) => void) | undefined) => {
    ...
    return <Autocomplete
        ...
        onChange={(event: any, newValue: google.maps.places.AutocompletePrediction | null) => {
            ...
            setValue(newValue);
            // Send outside
            newValue && props.setLocation && props.setLocation(newValue)
        }}
